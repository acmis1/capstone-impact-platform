...
| Database schema/RLS | Versioned | Migration tests and SQL contracts exist (10 timestamped migrations; migrations 0007 through 0010 repository/local-only) | Full production RLS verification pending |
