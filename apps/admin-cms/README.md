...
| Database schema/RLS | Versioned | Migration tests and SQL contracts exist (26 timestamped migrations; migrations 0007 through 0026 repository/local-only) | Full production RLS verification pending |
