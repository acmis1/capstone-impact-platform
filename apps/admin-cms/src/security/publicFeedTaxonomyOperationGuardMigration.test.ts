...
describe('public-feed taxonomy operation guard migration', () => {
  it('is a new forward migration and leaves both earlier Stream K migrations byte-identical', () => {
    ...
    expect(files[42]).toBe('20260825030000_public_feed_taxonomy_operation_guard.sql');
    expect(files[43]).toBe('20260826090000_public_feed_activation_authority_guard.sql');
    expect(files[44]).toBe('20260828090000_assistive_language_findings.sql');
    expect(files[45]).toBe('20260828120000_assistive_worker_heartbeat.sql');
    expect(files[46]).toBe('20260828170000_assistive_execution_control.sql');
    expect(files[47]).toBe('20260831090000_postgres17_maintain_privilege_alignment.sql');
    expect(files[48]).toBe('20260902010606_controlled_project_links_import.sql');
    expect(files[49]).toBe('20260903120000_participant_preview_controlled_links.sql');
    expect(files[50]).toBe('20260903130000_participant_owned_corrections.sql');
    expect(files[51]).toBe('20260906120000_public_removal_completion_reconciliation.sql');
    expect(files[52]).toBe('20260909120000_staff_lifecycle_readiness.sql');
    expect(files[53]).toBe('20260910120000_public_feed_rollback_capability.sql');
    expect(files[54]).toBe('20260910120100_participant_preview_access_observations.sql');
    expect(files[55]).toBe('20260910120200_assistive_worker_production_identity.sql');
    expect(files[56]).toBe('20260911120000_gallery_full_text_equivalents.sql');
    expect(files[57]).toBe('20260914100000_layout_recipe_library.sql');
    expect(files[58]).toBe('20260916120000_archived_project_restore.sql');
    expect(files[59]).toBe('20260917090000_archived_project_republish_media_rearm.sql');
    expect(files[60]).toBe('20260917120000_governed_project_soft_delete.sql');
