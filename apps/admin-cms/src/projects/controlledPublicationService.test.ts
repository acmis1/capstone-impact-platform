...
const mediaSources: PublicationMediaSource[] = [
  {
    ...
    storagePath: 'drafts/target/poster_image/poster.png',
    publicUrl: null,
  ...
  },
  {
    ...
    fileName: 'poster.pdf',
    storageBucket: PRIVATE_BUCKET,
    storagePath: 'drafts/target/poster_pdf/poster.pdf',
    publicUrl: null,
    publicStorageBucket: null,
    publicStoragePath: null,
  ...
  it('rejects recovered execution whose private source bytes no longer match the bound evidence', async () => {
    const recovered = completedAttempt({
      ...
      mediaManifest: [{
        ...
        sourcePath: 'drafts/target/poster_image/poster.png',
        publicBucket: PUBLIC_ASSETS_BUCKET,
        publicPath: 'published/target/poster_image/poster.png',
        publicUrl: `http://127.0.0.1/public/published/target/poster_image/poster.png`,
        preExisting: false,
