...
const candidate = {
  ...
  files: [{ role: 'poster_image', position: null, fileName: 'poster.png', mimeType: 'image/png', bytes: CONTENT.length, sha256: correctionDigest(CONTENT), altText: null, contentKind: null, fullText: null, content: CONTENT }],
