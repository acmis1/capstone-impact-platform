...
const fakeProjects = [
  {
    ...
    team_members: ['Participant Alice', 'Participant Bob'],
  ...
  },
  {
    ...
    team_members: ['Participant Charlie', 'Participant Diane'],
  ...
  },
  {
    ...
    team_members: ['Participant Evan', 'Participant Fiona'],
  ...
  },
  {
    ...
    team_members: ['Participant George', 'Participant Hannah'],
