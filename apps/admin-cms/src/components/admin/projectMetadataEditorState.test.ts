...
const metadata: ProjectMetadataView = { publicId: 'synthetic', title: 'Title', summary: 'Summary', background: '', solution: '', posterText: 'Poster full text', accessibilityText: 'Poster description', year: '2026', programId: 'a0000000-0000-4000-8000-000000000001', disciplineIds: ['b0000000-0000-4000-8000-000000000001'], industryCategoryIds: ['c0000000-0000-4000-8000-000000000001'], expectedUpdatedAt: '2026-01-01T00:00:00.000Z' };
