...
export const REQUIRED_RPC_SIGNATURES = [
  ...
  rpc('pre_preview_package_context', ['p_public_id', 'p_admin_id'], ['text', 'uuid']),
  rpc('reserve_participant_correction', ['p_token_hash', 'p_package_hash', 'p_metadata', 'p_files', 'p_warnings', 'p_bucket', 'p_validation_checks', 'p_public_id', 'p_admin_id'], ['text', 'text', 'jsonb', 'jsonb', 'jsonb', 'text', 'jsonb', 'text', 'uuid']),
  rpc('complete_participant_correction', ['p_token_hash', 'p_submission_id', 'p_package_hash', 'p_public_id', 'p_admin_id'], ['text', 'uuid', 'text', 'text', 'uuid']),
