...
*   **Admin CMS Foundation**: Modular Next.js app structure, TypeScript domain models, and migrations `0001` - `0024`. Migrations `0010` - `0021` established atomic import, review, participant-preview, correction, publication, removal, and metadata-audit foundations. Migration `0022` added controlled staff identity provisioning; Migration `0023` added participant preview email delivery; Migration `0024` adds explicit participant preview reminder scheduling and bounded due claiming. Migrations `0001` - `0023` remain unchanged, and migrations `0007` - `0024` are unapplied to hosted staging.
