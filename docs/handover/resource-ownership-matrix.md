...
| Redeployable | Yes | Yes — 54 migrations plus a restored backup reproduce it exactly |
...
3. Transfer or recreate the Supabase organisation and project; apply all 54 migrations; restore data
