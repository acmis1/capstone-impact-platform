...
| Redeployable | Yes | Yes — 52 migrations plus a restored backup reproduce it exactly |
...
3. Transfer or recreate the Supabase organisation and project; apply all 52 migrations; restore data
