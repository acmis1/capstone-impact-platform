...
| Redeployable | Yes | Yes — 53 migrations plus a restored backup reproduce it exactly |
...
3. Transfer or recreate the Supabase organisation and project; apply all 53 migrations; restore data
