...
| Redeployable | Yes | Yes — 51 migrations plus a restored backup reproduce it exactly |
...
3. Transfer or recreate the Supabase organisation and project; apply all 51 migrations; restore data
