...
| Redeployable | Yes | Yes — 56 migrations plus a restored backup reproduce it exactly |
...
3. Transfer or recreate the Supabase organisation and project; apply all 56 migrations; restore data
