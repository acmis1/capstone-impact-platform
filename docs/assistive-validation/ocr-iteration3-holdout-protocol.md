...
The content-addressed candidate manifest is embedded in [`evidence/ocr-iteration3/calibration-decision.json`](evidence/ocr-iteration3/calibration-decision.json). The identity-only [`candidate-freeze-commit.json`](evidence/ocr-iteration3/candidate-freeze-commit.json) binds corrected candidate-freeze commit `ddb837653c8698260becb536fa622d6b4ed2713f` and proves that commit contained no Iteration 3 holdout path. It supersedes `bd1e1a34b747c9c20dbfb6711cae0a427e36d223`, whose source manifest was built before final newline hygiene; that defect was found before any holdout seal or candidate output. The freeze records `origin/main` `606b44e2816c1ec43621f1237c8c528d59a1184d`, issue [#208](https://github.com/acmis1/capstone-impact-platform/issues/208), and branch `feat/assistive-ocr-iteration3-reading-order`.
