...
- **Migration History (Gate 3) — current verified observation**: 58 rows are recorded through `20260914100000_layout_recipe_library` after the governed Migration 0058 application.
...
deployed exact merged-main implementation SHA `90646e084f827e399617078b21a91dee3e899799`, verified
...
- **Migration History (Gate 3)**: Current hosted evidence is 58 rows through `20260914100000_layout_recipe_library`; the 46-row, 48/48, 52-row, and 57-row records remain historical observations.
...
- **Other Gates**: Render deployment identity has separately matched exact merged-main SHA `95fe7ea023f6eba0a0161f636aae05e721c018f2` in bounded read-only smoke. Current-52 Auth/Storage recovery remains separately documented above; UAT, monitoring, formal RPO/RTO, and release acceptance remain their own gates.
