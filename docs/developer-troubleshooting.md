...
> [!WARNING]
> `npm run supabase:reset` destroys the local database state and replays all 57 migrations through Migration 0057 from scratch. This affects **local** containers only. It does **not** touch hosted staging or production data.
