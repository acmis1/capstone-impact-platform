...
> [!WARNING]
> `npm run supabase:reset` destroys the local database state and replays all 59 repository migrations through Migration 0059 from scratch. This affects **local** containers only. It does **not** touch hosted staging or production data.
