...
> [!WARNING]
> `npm run supabase:reset` destroys the local database state and replays all 58 repository migrations through Migration 0058 from scratch. This affects **local** containers only. It does **not** touch hosted staging or production data.
