...
| :--- | :--- | :--- |
| **Auth and schema migrations** | 57 append-only versioned migrations through `20260911120000_gallery_full_text_equivalents`; current hosted staging records all 57 | `VERIFIED_STAGING`; fresh Gate 3/4 evidence is recorded in [Staging-57 Deployment Evidence](staging-57-deployment-evidence-2026-09-13.md) |
...
*   **Migration Contract**: The repository and active staging-v2 contain 57 versioned migrations, with fresh Gate 3/4 evidence recorded after the authorized forward application of Migrations 0053–0057. This does not authorize routine migration repair, `db push`, reset, or hosted mutation; repair requires a proven history mismatch and separate authorization.
