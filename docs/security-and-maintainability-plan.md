...
| :--- | :--- | :--- |
| **Auth and schema migrations** | 56 append-only versioned repository-candidate migrations through `20260910120200_assistive_worker_production_identity`; latest hosted evidence remains 52 | `REPOSITORY_VERIFIED`; Migrations 0053–0056 have no hosted evidence in this patch |
