...
| :--- | :--- | :--- |
| **Auth and schema migrations** | Candidate repository has 58 append-only migrations through `20260914100000_layout_recipe_library`; current hosted staging remains verified at 57 through Migration 0057 | Candidate 58 is `IMPLEMENTED_AND_TESTED`; hosted 57 remains `VERIFIED_STAGING` in [Staging-57 Deployment Evidence](staging-57-deployment-evidence-2026-09-13.md) |
...
*   **Migration Contract**: The repository candidate contains 58 versioned migrations; active staging-v2 remains verified at 57 after the authorized forward application of Migrations 0053–0057. Migration 0058 requires a separately authorized hosted forward application and refreshed Gate 3/4 evidence. This does not authorize routine migration repair, `db push`, reset, or hosted mutation; repair requires a proven history mismatch and separate authorization.
