...
| :--- | :--- | :--- |
| **Auth and schema migrations** | 54 append-only versioned repository-candidate migrations through `20260910120000_public_feed_rollback_capability`; latest hosted evidence remains 52 | `REPOSITORY_VERIFIED`; Migrations 0053–0054 have no hosted evidence in this patch |
