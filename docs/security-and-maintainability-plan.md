...
*   **Migration Contract**: Current `main` and active staging-v2 contain 58 versioned migrations through `20260914100000_layout_recipe_library`. The authorized Migration 0058 application preserved existing state and verified the new bounded layout-recipe/readiness authority; prior M57 Gate 3/4 totals remain historical evidence. This does not authorize routine migration repair, `db push`, reset, or hosted mutation; repair requires a proven history mismatch and separate authorization.
