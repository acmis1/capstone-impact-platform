...
*   **Planning & Architecture**: Documenting system boundaries, hard constraints, and schema expectations. All break work must be completely reversible and assume a free-tier hosting option to be verified later. Added draft planning documents [schema-draft.md](file:///d:/IT%20RMIT/Capstone/docs/schema-draft.md) and [public-feed-contract.md](file:///d:/IT%20RMIT/Capstone/docs/public-feed-contract.md) as non-blocking, reversible planning resources. Created [july-confirmation-pack.md](file:///d:/IT%20RMIT/Capstone/docs/july-confirmation-pack.md) as a concise agenda and decision checklist to prepare for the July meeting, which must be used before locking Part 2 implementation decisions.
