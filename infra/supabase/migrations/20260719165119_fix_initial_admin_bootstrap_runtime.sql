-- Staging database schema: fix initial admin bootstrap runtime function
-- 0006_fix_initial_admin_bootstrap_runtime.sql (Corrective Migration)
...
BEGIN
    ...
    -- Normalize email and full name using official pg_catalog.btrim
    v_normalized_email := pg_catalog.lower(pg_catalog.btrim(p_email));
    v_trimmed_full_name := pg_catalog.btrim(p_full_name);
